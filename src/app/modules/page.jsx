...
import {
    ...
    CheckCircle, Target, FileText, X, GraduationCap, Briefcase, Clock, Sparkles
} from 'lucide-react';
                                                ...
                                                {cat.hasTieredPricing ? (
                                                    <div className="space-y-2 mb-4">
                                                        <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
                                                            <div>
                                                                <p className="text-xs font-bold text-blue-600 uppercase tracking-wide">🎓 Student</p>
                                                                <p className="text-xs text-blue-500 mt-0.5">Requires ID verification</p>
                                                            </div>
                                                            <p className="text-2xl font-extrabold text-blue-700">KES {cat.studentPrice}</p>
                                                        </div>
                                                        <div className="flex items-center justify-between bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                                                            <div>
                                                                <p className="text-xs font-bold text-amber-600 uppercase tracking-wide">💼 Non-Student</p>
                                                                <p className="text-xs text-amber-500 mt-0.5">Immediate access</p>
                                                            </div>
                                                            <p className="text-2xl font-extrabold text-amber-700">KES {cat.nonStudentPrice}</p>
                                                        </div>
                                                    </div>
                                                ) : (
                                                    <>
