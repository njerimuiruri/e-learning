...
const HeroSection = () => {
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 overflow-hidden">
            ...
            <div className="absolute bottom-20 right-10 w-40 h-40 bg-slate-200 rounded-full opacity-20 blur-3xl"></div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="space-y-8 z-10">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                            ...
                            <br />
                            <span className="text-[#021d49]">Research, Writing</span>
                            <br />
                            & Policy Translation
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button className="bg-[#021d49] hover:bg-[#03275f] text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                                Get Started
                            ...
                            <button className="border-2 border-gray-300 hover:border-[#021d49] text-gray-700 hover:text-[#021d49] px-8 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 group">
                        ...
                        <div className="relative h-full">
                            ...
                            <div className="relative bg-white p-1 rounded-[3rem] shadow-2xl border-2 border-black w-full lg:w-[550px] h-[600px]">
                                <div className="rounded-[2.8rem] overflow-hidden h-full relative">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-slate-500/5 mix-blend-overlay pointer-events-none"></div>
                                </div>
                            </div>
