    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="text-sm text-white bg-[#021d49] hover:bg-orange-600 px-4 py-2 rounded-lg shadow transition"
        >
          Back to course
        </button>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
            ...
            <div className="mb-6">
              ...
              />
              <button
                className="bg-[#021d49] hover:bg-orange-600 text-white px-6 py-2 rounded-lg font-bold shadow transition w-full text-lg"
