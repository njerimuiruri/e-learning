                    ...
                    <div className="bg-white rounded-3xl shadow-2xl p-10 border-4 border-orange-200">
                        ...
                        <div className="bg-yellow-50 border-2 border-yellow-300 rounded-2xl p-6 mb-8">
                            ...
                            <ul className="space-y-2 text-gray-700">
                                ...
                                <li>All questions are multiple choice or true/false.</li>
            ...
            <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-orange-50">
                ...
                <div className="max-w-4xl mx-auto px-4 py-12">
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-orange-200">
                        <div
                            className={`${passed ? "bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500" : "bg-gradient-to-r from-red-500 via-orange-500 to-pink-500"} text-white p-12 text-center relative overflow-hidden`}
                        >
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-10 mb-6 border-2 border-orange-200">
                    <div className="mb-8">
                        ...
                        <h3 className="text-3xl font-bold text-gray-900 leading-snug">{question.question}</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                        {options.map((option, idx) => (
                            <label
                                key={idx}
                                className={`flex items-start gap-5 p-6 border-3 rounded-2xl cursor-pointer transition-all ${answers[questionId] === option
