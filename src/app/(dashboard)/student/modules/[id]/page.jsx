        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 overflow-x-hidden">
                ...
                <div className="flex relative">
                    {/* Sidebar - Lesson List */}
                    <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:sticky top-[57px] left-0 h-[calc(100vh-57px)] w-80 bg-white border-r overflow-y-auto z-20 transition-transform duration-300`}>
                        <div className="p-4">
                    ...
                    {/* Main Content Area */}
                    <div className="flex-1 min-h-[calc(100vh-57px)] lg:ml-0">
                                    ...
                                    {!showLessonAssessment && (
                                        <>
                                            ...
                                            {currentLesson.content && (
                                                <div className="bg-white rounded-2xl border-2 border-gray-100 p-6 sm:p-8 mb-6 prose prose-gray max-w-none">
