...
const TeamSection = () => {
    ...
    return (
        <>
            <section className="py-16 lg:py-24 bg-gradient-to-b from-white to-blue-50 relative overflow-hidden">
                            ...
                            >
                                ...
                                <div className="relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <p className="text-[#021d49] font-medium text-sm mb-1">
                                            {member.role}
                                        </p>
                                    ...
                                    {/* Decorative Element */}
                                    <div className="absolute top-4 right-4 w-12 h-12 bg-[#021d49] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
